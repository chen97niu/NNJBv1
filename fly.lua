...
mainBtn.Position = UDim2.new(0.5, -32, 0.5, -32)  -- 正中间
...
menu.Size = UDim2.new(0, 240, 0, 290)
menu.Position = UDim2.new(0.5, -120, 0.4, 0)
...
speedText.Position = UDim2.new(0.1, 0, 0, 115)
...
speedContainer.Size = UDim2.new(0.9, 0, 0, 45)
speedContainer.Position = UDim2.new(0.05, 0, 0, 150)
...
for i = 1, 5 do
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        for j, b in pairs(speedBtns) do
            b.BackgroundColor3 = (j == currentSpeed) and Color3.fromRGB(255, 100, 0) or Color3.fromRGB(50, 50, 65)
        end
